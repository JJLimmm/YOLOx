...
class LRScheduler:
    ...
    def update_lr_func(self):
        self.lr_func = self._get_lr_func(self.name)

    def __str__(self):
        return f"{self.name} LRScheduler with {self.lr} base learning rate, scheduled across {self.total_iters} iters"
